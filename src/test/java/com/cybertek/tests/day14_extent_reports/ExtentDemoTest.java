...
public class ExtentDemoTest {
    ...
    public void setup(){
        ...
        String projectPath = System.getProperty("user.dir"); // path of project
        String path = projectPath + "/test-output/report.html"; // path of report , we did not create it
                                    //folder name/file name    //  it will be created during the execution
