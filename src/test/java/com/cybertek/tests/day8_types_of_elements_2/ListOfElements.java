...
public class ListOfElements {
    ...
    public void test2(){
        ...
        List<WebElement> buttons = driver.findElements(By.tagName("buttonaiysdgausda"));// wrong locator but still run

        System.out.println("buttons.size() = " + buttons.size()); // you should verify size, in case wrong locator run
    }
