...
public class SelectDropdownTest {
    ...
    public void test1(){
        ...
        Select stateDropdown = new Select(dropdownElement);// Select is a class in Selenium
       ...
       // System.out.println("stateDropdown.getFirstSelectedOption() = " + stateDropdown.getFirstSelectedOption().getText()); // i tried
       // System.out.println("options.get(0).getText() = " + options.get(0).getText());                                       // i tried
