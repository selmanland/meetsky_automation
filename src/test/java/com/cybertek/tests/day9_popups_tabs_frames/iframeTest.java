...
public class iframeTest {
    ...
    public void test1() throws InterruptedException {
        ...
        //1.Switch using by name or ID attribute of iframeExercise
        ...
        //3.USING WEBELEMENT
        //locating iframeExercise with any valid locator
...
·       We can only switch from parent to child, or from child to parent.
    ...
    public void test2(){
        ...
        //go to main html to switch bottom frame , you can switch child to main html directly
        driver.switchTo().defaultContent();
